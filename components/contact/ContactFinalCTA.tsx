...
const whatsappLink =
  "https://wa.me/551132302090?text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Astreon%20Tech%20e%20quero%20solicitar%20um%20diagn%C3%B3stico.";
        ...
        <FadeIn>
          <div className="rounded-[2rem] border border-cyan-400/20 bg-slate-900/90 p-8 text-center shadow-2xl shadow-cyan-950/30 md:p-12">
            ...
            <h2 className="mx-auto mt-4 max-w-4xl text-3xl font-bold sm:text-4xl md:text-5xl">
              Quanto antes organizar a tecnologia, menor o impacto na operação.
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
              Converse com a Astreon Tech e descubra como melhorar atendimento,
              infraestrutura, segurança e suporte da sua empresa.
            </p>
