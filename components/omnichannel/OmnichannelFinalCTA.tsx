...
export default function OmnichannelFinalCTA() {
  return (
        ...
        <FadeIn>
          <div className="rounded-[2rem] border border-cyan-400/20 bg-slate-900/90 p-8 text-center shadow-2xl shadow-cyan-950/30 md:p-12">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
              Solicite uma demonstração e entenda qual plano faz mais sentido
              para sua equipe, volume de atendimento e necessidade de implantação.
            </p>
